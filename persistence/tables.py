...
class SandboxContainerRow(Base):
    ...
    container_id: Mapped[str] = mapped_column(String(128), nullable=False, unique=True)
    status: Mapped[str] = mapped_column(String(50), nullable=False)
    ...
    __table_args__ = (
        ...
        Index("ix_sandbox_container_status", "status", "created_at"),
    )
